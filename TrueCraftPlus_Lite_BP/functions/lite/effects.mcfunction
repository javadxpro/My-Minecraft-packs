...
execute as @a[scores={tc_temp=..3}] if score qm5 tc_meta matches 0 run damage @s 1 freeze
# heat
...
execute as @a[scores={tc_temp=96..}] if score qm30 tc_meta matches 0 run effect @s nausea 9 0 true
# heatstroke damage every 5s
execute as @a[scores={tc_temp=94..}] if score qm5 tc_meta matches 0 run damage @s 1 magic
# dehydration damage every 5s
execute as @a[scores={tc_thirst=..0}] if score qm5 tc_meta matches 0 run damage @s 1 starvation
