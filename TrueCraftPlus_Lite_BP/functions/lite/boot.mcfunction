...
scoreboard players set qz0 tc_meta 52
scoreboard players set qz1 tc_meta 82
scoreboard players set qz2 tc_meta 12
scoreboard players set qz3 tc_meta 30
scoreboard players set qz4 tc_meta 46
scoreboard players set qc10 tc_meta 10
scoreboard players set qwdur tc_meta 0
scoreboard players set qnight tc_meta 0
scoreboard players set qwstate tc_meta 0
scoreboard players set qf1 tc_meta 0
scoreboard players set qf5 tc_meta 0
scoreboard players set qf10 tc_meta 0
scoreboard players set qf30 tc_meta 0
scoreboard players set qf100 tc_meta 0
scoreboard players set qinit tc_meta 1
